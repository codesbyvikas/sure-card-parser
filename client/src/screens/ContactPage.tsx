...
const ContactPage: React.FC = () => {
  return (
    <div className="bg-background-dark min-h-screen font-display px-4 py-10 md:px-10 flex flex-col items-center">
      <h1 className="text-4xl font-bold text-white text-center mb-8">
        Contact Me
      </h1>
      <div className="bg-[#1A1F26] p-8 rounded-2xl max-w-xl w-full space-y-6">
